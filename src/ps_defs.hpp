...
#define PS_DEBUG_PRINT(a,b) { std::cout<<"rank="<<Comm::getRank()<<" function: "<<__FUNCTION__<<" "<<(a)<<"="<<(b)<<std::endl; }
#define PS_DEBUG_PRINT2(a,b,c,d) { std::cout<<"rank="<<Comm::getRank()<<" function: "<<__FUNCTION__<<" "<<(a)<<"="<<(b)<<" "<<(c)<<"="<<(d)<<std::endl; }
#else
#define PS_DEBUG_PRINT(a,b) { std::cout<<" function: "<<__FUNCTION__<<" "<<(a)<<"="<<(b)<<std::endl; }
#define PS_DEBUG_PRINT2(a,b,c,d) { std::cout<<" function: "<<__FUNCTION__<<" "<<(a)<<"="<<(b)<<" "<<(c)<<"="<<(d)<<std::endl; }
#endif
#else
#define PS_DEBUG_PRINT(a,b)
#define PS_DEBUG_PRINT2(a,b,c,d)
#endif
