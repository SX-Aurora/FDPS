...
namespace ParticleSimulator{
	...
	ftrace_region_begin("make_LET_1st");
	    ...
	    ftrace_region_begin("make_LET_1st__exchange_top_moment");
	    ...
	    ftrace_region_end("make_LET_1st__exchange_top_moment");
        }
        if(!flag_reuse){
	    ...
	    ftrace_region_begin("make_LET_1st__find_particle");
	    ...
	    ftrace_region_end("make_LET_1st__find_particle");
            const F64 time_offset_exchange_n = GetWtime();
	    ftrace_region_begin("make_LET_1st__exchange_n");
	    ...
	    ftrace_region_end("make_LET_1st__exchange_n");
...
PS_OMP(omp parallel for reduction(+:n_ep_recv_tot_tmp), reduction(+:n_sp_recv_tot_tmp))
	...
	ftrace_region_end("make_LET_1st");
        F64 wtime_ex_let_comm = 0.0;
        time_offset = GetWtime();
	ftrace_region_begin("exchange_LET_1st");
...
PS_OMP_PARALLEL
	...
	ftrace_region_end("exchange_LET_1st");
