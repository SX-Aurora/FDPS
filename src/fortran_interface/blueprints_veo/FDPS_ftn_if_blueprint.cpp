...
void fdps_veo_initialize(char *veo_dll) {
   VEO_Initialize(veo_dll);
}
...
void fdps_create_tree(int *tree_num,
   ...
   //create_tree(tree_num,tree_info,pFuncPrepareEpjSymbol,pFuncEpEpSymbol);
   create_tree(tree_num,tree_info,pFuncPrepareEpjSymbol,pFuncEpEpSymbol,pFuncPrepareSpjSymbol,pFuncEpSpSymbol);
}
//void fdps_create_tree(int *tree_num,
//                      char *tree_info) {
...
void fdps_dump_profile_tree(const int tree_num,const char* p_title) {
   dump_profile_tree(tree_num,p_title);
}
