...
namespace FDPS_Manipulators {
   ...
   extern void VEO_Initialize(char *veo_dll);
#endif
   //--------------------------------
   ...
   extern void create_tree(int *tree_num,
                           char *tree_info,
                           const char *pFuncPrepareEpjSymbol,
                           const char *pFuncEpEpSymbol,
                           const char *pFuncPrepareSpjSymbol,
                           const char *pFuncEpSpSymbol);
#else
   extern void create_tree(int *tree_num,
                           char *tree_info);
#endif
   extern void delete_tree(const int tree_num);
   extern void dump_profile_tree(const int tree_num,const char* p_title);
