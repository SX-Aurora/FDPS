...
namespace ParticleSimulator{
    ...
    public:
	    ...
	    ftrace_region_begin("collect_sample_particle");
	    ...
	    ftrace_region_end("collect_sample_particle");
            return;
        }
        ...
        void decomposeDomain() {
            F64 time_offset = GetWtime();
	    ftrace_region_begin("decompose_domain");
...
PS_OMP_PARALLEL_FOR_G
	    ...
	    F64 wtmp3 = GetWtime();
            ...
            ftrace_region_end("decompose_domain");
        }
