...
// modified to limit # of sample particles by M.I. 
	...
	void exchangeParticleImpl(ReallocatableArray<S32> & rank_glb_comm,
	    ...
	    ftrace_region_begin("exchange_particle");
            ...
            ftrace_region_begin("exchange_particle__find_particle");
...
PS_OMP_BARRIER
	    ...
	    ftrace_region_end("exchange_particle__find_particle");
	    ...
	    etime2=GetWtime();
	    ftrace_region_begin("exchange_particle__exchange_particle");
            /*
	    ...
	    ftrace_region_end("exchange_particle__exchange_particle");
            n_send.freeMem();
            n_disp_send.freeMem();
            n_recv.freeMem();
            n_disp_recv.freeMem();
	    ...
	    ftrace_region_end("exchange_particle");
        }
