...
subroutine f_main()
   ...
   call fdps_ctrl%VEO_Initialize('libvenbody.so'//c_null_char)
   ...
   call fdps_ctrl%create_tree(tree_num, &
                              ...
                              "prepare_epj_for_force", "calc_gravity_ep_ep", &
                              "prepare_spj_for_force", "calc_gravity_ep_sp" )
   ...
   !call fdps_ctrl%dump_profile_tree(tree_num, "CalcGrav")

   !start add for VEO
   call fdps_ctrl%delete_tree(tree_num)
   !end add for VEO
   !* Finalize FDPS
