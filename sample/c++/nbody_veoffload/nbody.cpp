...
int main(int argc, char *argv[]) {
    ...
    VEO::VeoInterface::initialize((const char *)argv[0],"libvenbody.so");
#endif
    PS::F32 theta = 0.5;
   ...
   //CalcGravitySpj       funcCalcGravitySpj("calc_gravity_spj",funcCalcGravity.getFuncEpEpPtr());
...
#if defined(_SX_VEOFFLOAD)
    funcCalcGravity.cleanup();
    funcCalcGravitySpj.cleanup();
#endif
